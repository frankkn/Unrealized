  ...
  UNREALIZED.endings = {
    ...
    full: [
      ...
      },
      {
        ...
        when: function (state) {
          // 原本要「被取代」旗標，但那個節點刪掉了；對 2005 世代來說
          // 「入門工作被系統接手」本來就是整代人的前提，不需要旗標來證明
          return state.generation === 2005 && state.chapter >= 7 &&
      ...
      },
      {
        ...
        when: { flagsAny: ['遇到風暴', '錯過紅利'], attr: { key: 'achieve', op: '<=', value: 6 }, attrs: [{ key: 'money', op: '<=', value: 5 }, { key: 'bond', op: '<=', value: 6 }] },
        title: '差一年',
