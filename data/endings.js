  ...
  UNREALIZED.endings = {
    ...
    full: [
      ...
      },
      {
        ...
        title: '那條巷子出來的',
        text: '你買下的第一棟樓，站在頂樓看得到小時候那條巷子。那間鐵皮加蓋還在，現在租給別人。同輩裡沒有人料到是你——包括你自己，包括每一個當年說你這種家庭大概就這樣的老師。你沒有回去跟誰講過一句話，也沒有必要。你媽走得早，沒有看到這一天；她要是看到了，第一句大概還是問你有沒有吃飯。',
        limitedTo: undefined
      },
      {
      ...
      },
      {
        ...
        when: { flagsAny: ['富裕', '家世'], attr: { key: 'self', op: '<=', value: 3 } },
        title: '那個姓氏',
