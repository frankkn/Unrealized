...
53 張節點場景圖的 prompt。用任何生圖工具產完，命名成 `art/<節點ID>.webp` 丟進這個資料夾即可——**引擎會自動抓，沒有的就退回像素雕版**，所以可以一次做一張，不用等全部做完。
...
| 格式 | WebP，品質 80。53 張控制在 15MB 內，repo 才不會腫 |
...
一致性全靠這段。**不要每張改寫它**，否則 53 張會像 53 個不同的遊戲。
...
53 張分開生，最大的風險是風格漂移。**先產一張你滿意的當基準，之後每一張都拿它當參考**：
...
### n0_siblings — 家裡幾個小孩
> 傍晚的老式客廳，矮桌上擺著好幾副碗筷，門口幾雙鞋。
`late afternoon in an old Taiwanese living room, a low table with rice bowls set out for several children, three small pairs of shoes by the door, one child seen from behind in the doorway, television glow, family of many`
...
### n3_the_friends — 那幾個朋友
> 夜裡的路邊攤，塑膠椅，一桌四五個人的背影。
`night, a Taiwanese roadside eatery with plastic stools and a strip light, four or five young people seen from behind crowded around one small table, scooters parked at the kerb, steam, easy noise`
...
### n5_windfall — 意料之外的一筆
> 黃昏的空地，重劃的界樁，遠處一支吊車。
`golden late afternoon, an empty plot of land on the edge of a Taiwanese town with new survey stakes and a distant crane, one adult seen from behind standing at the fence looking across it, betel palms, unexpected fortune`
...
`night, a balcony of an apartment block, one adult in their forties seen from behind holding a phone to their ear, city lights below, laundry drying beside them, the call going on longer than expected`
